<template>
    <section class="bg-white py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div v-for="item in products" :key="item.id" class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col" >
                <!--<a href="product" >-->
                <inertia-link :href="route('product.show', { id: item.id })" method="get" >


                    <img class="hover:grow hover:shadow-lg" :src=images[Math.floor(Math.random()*images.length)]>
    ...
    export default {
        ...
        computed:{
            getimageurl: function () {
                ...
                // get random item
                var item = this.images[randomIndex];
